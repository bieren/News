			...
			<div class="span3">
				<div class="newsMenu">
					<ul class="nav nav-tabs nav-stacked">
						...
						<li><a href="${pageContext.request.contextPath}/news?action=preSa11ve">&nbsp;&nbsp;新闻添加</a></li>
						...
						<li><a href="${pageContext.request.contextPath}/newsType?action=preSa11ve">&nbsp;&nbsp;新闻类别添加</a></li>
						<li><a href="${pageContext.request.contextPath}/newsType?action=backList">&nbsp;&nbsp;新闻类别维护</a></li>
						<li><a href="#"><strong>友情连接管理</strong></a></li>
						<li><a href="${pageContext.request.contextPath}/link?action=preSa11ve">&nbsp;&nbsp;友情连接添加</a></li>
