	...
	<div class="span12">
		<div>
			...
			<div class="headRight">
				...
				欢迎管理员：<font color="red">${currentUser.userName }</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:logout()">[&nbsp;安全退出&nbsp;]</a>&nbsp;&nbsp;<a target="_blank" href="${pageContext.request.contextPath }">去前台看看</a>&nbsp;&nbsp;<font id="today" class="currentDateTime"></font>
			</div>
		</div>
	</div>
</div>
