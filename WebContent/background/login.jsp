...
<div id="login-wrapper" class="png_bg">
  ...
  <div id="login-content"  >
    <form action="${pageContext.request.contextPath}/user?action=login" method="post" onsubmit="return checkForm()">
      <p>
        <label>用户名:</label>
      <input class="text-input" style="height: 30px;" type="text" id="userName" name="userName" value="${userName }"/>
      </p>
      <div class="clear"></div>
      <p>
        <label>密码:</label>
        <input class="text-input" style="height: 30px;" type="password" id="password" name="password" value="${password }"/>
      </p>
      <div class="clear"></div>
