...
/////////////////////////////////////////////////////////////////
	   ...
	   /* StringUtil.Html2Text(headNews.getContent())去除html标签  头条内容不应该包含标签*/
...
/////////////////////////////////////////////////////////////////
	    ...
	    sql="select * from t_link order by orderNum";//通过orderNum升序查询
	    List<Link> linkList=linkDao.linkList(con, sql);
	    request.setAttribute("linkList", linkList);
	    
	    request.getRequestDispatcher("index.jsp").forward(request, response);//内部转发
